...
// --- Get All Content Template Categories ---
export const getContentCategories = (): { id: ContentTemplate['category']; name: string; nameZh: string; icon: string }[] => {
  return [
    { id: 'tutorial', name: 'Tutorials', nameZh: '教程知识', icon: '📖' },
    { id: 'story', name: 'Stories', nameZh: '故事叙事', icon: '✍️' },
    { id: 'promotion', name: 'Promotions', nameZh: '推广营销', icon: '📣' },
    { id: 'newsletter', name: 'Newsletters', nameZh: '简报周刊', icon: '📰' },
    { id: 'report', name: 'Reports', nameZh: '数据报告', icon: '📊' },
    { id: 'lifestyle', name: 'Lifestyle', nameZh: '生活方式', icon: '🌟' }
  ];
};
